    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.topSection}>
                <Text style={styles.headerText}>Add your mobile Number
                    for extra authentication</Text>
                <Text style={{ marginBottom: 24, color: '#4F4F4F' }}>Kindly enter your phone number</Text>
