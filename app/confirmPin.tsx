...
export default function confirmPin() {
    ...
    const handleContinue = async () => {
        console.log('pin', registrationData.pin);
        console.log('cpin', pin);


        if (registrationData.pin !== pin) {
            return Alert.alert('Error', 'Pin does not match')
        }
        try {
            const { data } = await api.post('/users/set-pin', { pin: pin })
        } catch (error:any) {
